...
if __name__ == "__main__":
    ...
    # target_path="E:\\ALL SUBJECTS\\all sem\\sem-6\\ai\\Paper-Evaluation-using-AI-master\\output\\iam\\flor\\checkpoint_weights.hdf5"
    ...
    if args.transform:
        ...
        #assert os.path.isfile("E:\ALL SUBJECTS\all sem\sem-6\ai\Paper-Evaluation-using-AI-master\output\iam.hdf5") or os.path.isfile(target_path)
